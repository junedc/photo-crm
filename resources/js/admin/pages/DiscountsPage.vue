...
<template>
    <section class="flex flex-wrap items-center gap-x-4 gap-y-2 rounded-2xl border border-white/10 bg-white/[0.03] px-5 py-3 shadow-lg shadow-black/10">
        ...
        <h2 class="text-sm font-bold italic text-white">Manage customer discount campaigns</h2>
    ...
    <section class="rounded-2xl border border-white/10 bg-white/[0.03] p-3">
            ...
            <div class="px-2">
                ...
                <div class="mt-2 flex items-center justify-between gap-3">
                    <div class="flex items-center gap-3">
                        <h3 class="text-sm font-semibold italic">Discount list</h3>
        ...
        <div class="max-h-[70vh] overflow-y-auto">
            <a
                ...
                class="grid w-full grid-cols-[160px_minmax(0,1.1fr)_180px_140px_220px] items-center gap-3 border-b px-3 py-3 text-left transition hover:bg-white/[0.03]"
            >
                <div class="min-w-0">
                ...
                <div class="min-w-0">
                    <span class="inline-flex h-8 items-center justify-center rounded-full bg-violet-400/15 px-3 text-center text-[11px] font-medium leading-none text-violet-200">
                        {{ valueLabel(discount) }}
                    </span>
                </div>
                <div class="min-w-0">
