...
<template>
    <section class="rounded-2xl border border-white/10 bg-white/[0.03] px-5 py-4 shadow-lg shadow-black/10">
        ...
        <h2 class="mt-2 text-xl font-semibold tracking-tight">Create and review packages</h2>
    ...
    <section class="rounded-2xl border border-white/10 bg-white/[0.03] p-3">
        ...
        <div class="max-h-[70vh] overflow-y-auto">
            ...
            >
                ...
                <span class="rounded-full px-2.5 py-1 text-[11px] font-medium" :class="entry.is_active ? 'bg-emerald-400/15 text-emerald-200' : 'bg-stone-700/60 text-stone-300'">
