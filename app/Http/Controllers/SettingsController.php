...
class SettingsController extends Controller
{
    ...
    public function updateWorkspace(CurrentTenant $currentTenant, Request $request): RedirectResponse|JsonResponse
    {
        ...
        $data = $request->validate([
            ...
            'booking_number_prefix' => ['nullable', 'string', 'max:20'],
        ...
        $tenant->fill([
            ...
            'booking_number_prefix' => $data['booking_number_prefix'] ?? null,
    ...
    private function serializeTenant(?Tenant $tenant): ?array
    {
        ...
        return [
            ...
            'booking_number_prefix' => $tenant->booking_number_prefix ?? 'BK',
